...
*   **화력 (Firepower)**: 적의 조직력(초록색 바)에 가하는 피해량을 결정합니다. 부대가 실질적으로 얼마나 적을 효과적으로 적을 공격할 수 있는지를 나타냅니다.
...
*   **조직 방어력 (Organization Defense)**: 부대가 유기적인 움직임을 통해 얼마나 적의 공격을 효과적으로 막아낼 수 있는지를 나타냅니다.
*   **단위 방어력 (Unit Defense)**: 부대의 각 유닛들이 얼마나 적의 공격을 효과적으로 막아낼 수 있는지에 따라 결정됩니다.
...
부대:
    ...
    본부중대 : 모든 대대이상 부대는 본부 중대를 가짐. 본부 중대는 데이터상 편제상으로만 존재함
...
전투 알고리즘:
    대대 휘하 중대 들은 지속적으로 자신의 전투 효율성을 최대화 시킬 수 있는 위치로 이동함
    중대는 소속된 대대가 어떤 식으로 배치되어있는지를 표현하는 단위이며,  중대 들은 그 중대 자체가 공격을 해서 적 중대에게 피해를 입힌다.
...
정면전투 : 적이 나를 주 대상으로 지정했고, 나도 적을 주 대상으로 지정했을 때 발생한다.
측면전투 : 내가 적을 주 대상으로 지정했는데, 적은 나를 주 대상으로 지정하지 않았을 때
          혹은 적이 나를 주 대상으로 지정했는데, 나는 적을 주 대상으로 지정하지 않았을 때 발생한다.
          
          측면전투는 공격을 당하는 쪽이 최대한 적을 지연시키고 방어하는 양상을 띈다.


        전투 메커니즘 : 
            정면전투 :   일정 주기로 턴이 돌아간다. 그 턴 마다 싸우는 중대 둘이 서로 얼마의 피해를 입고, 입힐지 결정한다.
                        소속된 대대의 목표가 공격인지 방어인지 따라 결정된다.
                        공격 vs 공격 : 