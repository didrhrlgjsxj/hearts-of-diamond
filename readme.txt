...
*   **조직 방어력 (Organization Defense)**: 부대가 유기적인 움직임을 통해 얼마나 적의 공격을 효과적으로 막아낼 수 있는지를 나타냅니다. 화력에 의해 관통됩니다.
*   **단위 방어력 (Unit Defense)**: 부대의 각 유닛들이 얼마나 적의 공격을 버텨낼 수 있는지에 따라 결정됩니다.
