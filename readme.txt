...
*   **단위 방어력 (Unit Defense)**: 부대의 각 유닛들이 얼마나 적의 공격을 버텨낼 수 있는지에 따라 결정됩니다. **직접 화력**에 의해 관통됩니다. 모든 부대는 훈련 수준(조직력 보너스)에 따른 **기본 생존성**을 가지며, 기갑 부대는 여기에 장갑과 기갑화율에 따른 **추가 방호력**을 더하여 계산됩니다.
