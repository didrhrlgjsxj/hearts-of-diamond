...
const UNIT_TYPE_STATS = {
    ...
    'RECON':    { directFirepower: 1.3, indirectFirepower: 1, softAttack: 0.55, hardAttack: 0.25, reconnaissance: 20, armor: 0, organizationBonus: 4, mobility: 15, tags: ['INFANTRY', 'SUPPORT'] },
    'ARMOR':    { directFirepower: 1.5, indirectFirepower: 1, softAttack: 0.65, hardAttack: 0.6, reconnaissance: 3, armor: 6, organizationBonus: 3, mobility: 25, tags: ['ARMOR'] },
    'ARTILLERY':{ directFirepower: 0.65, indirectFirepower: 1.4, softAttack: 1.1, hardAttack: 0.7, reconnaissance: 2, armor: 0, organizationBonus: 2, mobility: 8, tags: ['SUPPORT'] },
    'ENGINEER': { directFirepower: 2, indirectFirepower: 1, softAttack: 0.35, hardAttack: 0.5, reconnaissance: 2, armor: 3, organizationBonus: 4, mobility: 10, tags: ['INFANTRY', 'SUPPORT'] },
};
